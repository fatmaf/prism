package thts.testing.debugging;
...
public class GenerateFaultyConfigsSmallExample {
    ...
    public static ArrayList<Configuration> getSelectedConfigsFromFiltered(ArrayList<Configuration> allconfigs) {
        String[] configNames = {
             //   "L_LUGreedyFC_GP",
              //  "L_LUGreedyRandomFC_GP",
                "L_LUGreedyFC_MCD_GP_ASBU",
//                "L_LUGreedyRandomFC_GP_ASBU",
//                "L_eLUGreedyFC_GP_ASBU",
//                "L_eLUGreedyRandomFC_GP_ASBU",
//                "L_Cost_LUGreedyRelFC_GP_ASBU",
//                "L_Cost_LUGreedyRandomRelFC_GP_ASBU",
//                "L_Cost_eLUGreedyRelFC_GP_ASBU",
//                "L_Cost_eLUGreedyRandomRelFC_GP_ASBU",

                //   "L_LUGreedy_GP",
               // "L_LUGreedyRandom_GP",
     //           "L_LUGreedy_GP_ASBU",
       //         "L_LUGreedyRandom_GP_ASBU",
...
//                , "L_Cost_eLUGreedyRandomRelFC_MCD_GP_SASH_ASBU"
    ...
    public static void runSmallExampleSelectedConfig() {
        ...
        int maxruns = 10;
        String resSuffix = "_debugging_" + maxruns;
        ...
        for (int i = 0; i < configs.size(); i++) {
            ...
            try {
                ...
                runconfig.run(resFolderExt, config,
                        2, 2, filename, true, resSuffix, "_mult", maxruns, 0, 1);
                testsSofar += maxruns;
