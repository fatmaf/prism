...
public class TestLRTDPNestedMaSAS_rolloutpol_uct {

	// running this from the commandline
	// PRISM_MAINCLASS=thtsNew.Scratch.TestLRTDPNestedMaSAS_rolloutpol prism/bin/prism
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		try {
			TestLRTDPNestedMaSAS_rolloutpol_uct tester = new TestLRTDPNestedMaSAS_rolloutpol_uct();
			...
			FileWriter fw = new FileWriter(resultsLocation + "towardsmcts_uct.csv", true);
...
// things to do 
	...
	//we need to look at the thtsNew.thts paper okay
...
//		System.in.read();
	...
	THTSRunInfo unavoidableSingleAgentSolH(boolean debug,int run,double uctC) throws Exception {
		...
		String currentDir = System.getProperty("user.dir");
		String testsLocation = currentDir + "/tests/wkspace/tro_examples/";
		String resultsLocation = testsLocation + "results/towardsmcts/uct/";
...
//		goalack = thtsNew.thts.runThroughMostProb(greedyActSel, resultsLocation);
		rinfo.goalOnProbablePath = goalack[0];
//		goalack = thtsNew.thts.runThrough(greedyActSel, resultsLocation);
