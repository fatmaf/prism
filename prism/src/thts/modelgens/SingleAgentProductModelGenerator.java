...
public class SingleAgentProductModelGenerator extends DefaultModelGenerator {
	...
	public SingleAgentProductModelGenerator(ModulesFileModelGenerator modelGen, DA<BitSet, ? extends AcceptanceOmega> da,
