...
public class MultiAgentHeuristicTCRelPenalty implements Heuristic {
    ...
    public MultiAgentHeuristicTCRelPenalty(MultiAgentNestedProductModelGenerator mapmg,
                                           ArrayList<HashMap<Objectives, HashMap<State, Double>>> singleAgentSolns,
        ...
        if (isDeadend | isGoal) {
            ...
            for (Objectives obj : objs) {
                switch (obj) {
                    ...
                    case Cost: {
                        if (isDeadend) {
                            double lb = minMaxVals.get(obj).getValue()*mapmg.getRemainingTasksFraction(s);
                            double ub = minMaxVals.get(obj).getValue()*mapmg.getRemainingTasksFraction(s);
                            b = new Bounds(ub, lb);
