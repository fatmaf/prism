...
import thts.treesearch.actionselector.ActionSelectorGreedyBoundsDiff;
import thts.treesearch.actionselector.ActionSelectorGreedySimpleLowerBound;
import thts.treesearch.backup.BackupFullBellman;
...
import thts.treesearch.heuristic.MultiAgentHeuristic;
...
//
		...
		//thtsNew.thts.runThrough(new ActionSelectorGreedySimpleLowerBound(tieBreakingOrder,false),resultsLocation);
			...
			String propertiesFileName,String resultsLocation) throws Exception
	{
		...
		Heuristic heuristicFunction = new MultiAgentHeuristic(mapmg,singleAgentSolutions,Double.MAX_VALUE);
