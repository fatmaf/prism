...
public class ActionSelectorGreedySimpleLowerUpperBound implements ActionSelector {

	Random rgen;
	ArrayList<Objectives> tieBreakingOrder;

	public ActionSelectorGreedySimpleLowerUpperBound(ArrayList<Objectives> tieBreakingOrder) {
